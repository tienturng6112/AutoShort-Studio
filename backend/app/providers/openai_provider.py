...
class OpenAICompatibleProvider(BaseAIProvider):
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None, provider_name: str = "chatanywhere"):
    ...
    async def list_models(self) -> List[str]:
        try:
            ...
            # (no models returned - provider is removed)
    ...
    async def generate_text(
        ...
        extra_args = {}
        if json_mode:
            # Groq, ChatAnywhere, and Ollama support response_format
            if self.provider_name in ["chatanywhere", "groq", "ollama"]:
